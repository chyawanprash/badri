...
// other argument this app's own launchers pass (--installed-via=,
// Electron/Chromium's own --flags). A real directory is a reliable signal:
// nothing else ever present in this app's argv resolves to one, so the first
// argv entry that does is the dropped folder.
//
